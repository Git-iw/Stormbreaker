...
class Board:
    ...
    @classmethod
    def draw(cls, screen):
        # colors = [pygame.Color(153, 102, 51), pygame.Color(255, 255, 255)] # 0 is Brown and 1 is white
        colors = [pygame.Color(205, 133, 63), pygame.Color(255, 255, 255)] # 0 is Brown and 1 is white
